...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-28 lg:py-36  flex items-center">
      <div className="absolute inset-0 flex items-center justify-center">
        <img
          alt=""
          aria-hidden="true"
          src="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/patterns/square-alt-grid.svg"
          className="w-full h-full object-cover [mask-image:radial-gradient(75%_75%_at_center,white,transparent)] opacity-90"
        />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-4xl flex-col items-center">
          <div className="flex flex-col items-center gap-5 sm:gap-6 text-center">
            <div className="rounded-xl bg-background/30 p-3.5 sm:p-4 shadow-sm backdrop-blur-sm">
              <Logo />
            </div>
            ...
            <div>
              ...
              <p className="mx-auto max-w-2xl text-base sm:text-lg lg:text-xl text-muted-foreground leading-relaxed">
                ...
                mangrove forests of the Sundarbans and the tea gardens of Sylhet
                — find a guided tour built around where you want to go.
              </p>
            </div>

            {/* Search bar */}
            <div className="w-full max-w-2xl mt-2 sm:mt-4">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 p-2 sm:p-1.5 rounded-2xl sm:rounded-full bg-background border border-muted shadow-lg sm:items-center">
